...
library(plyr)
redwine.dat<-read.table("/Users/apple/Desktop/img/winequality/winequality-red.csv", sep = ";", header=T)
str(redwine.dat)
summary(redwine.dat)
whitewine.dat<-read.table("/Users/apple/Desktop/img/winequality/winequality-white.csv", sep = ";", header=T)
str(whitewine.dat)
